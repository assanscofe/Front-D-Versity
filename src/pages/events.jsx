...
const Events = () => {
    ...
    useEffect(() => {
        setCollection([...new Set(dataEvent.map((elt) => dataPassion.find(passion => passion.id === elt.passion).passionName))])
    }, [dataEvent, dataPassion])


    const handleFilter = (item) => {
        const filterData = dataEvent.filter((elt) => dataPassion.find(passion => passion.id === elt.passion).passionName === item)
        setData(filterData)
    }
        ...
        <>
            <Stack direction={'column'} spacing={2} sx={{
                ...
                <Grid container
                    ...
                    {
                        data.map((elt, index) => (
                            <Grid item xs={12} sm={6} md={4} xl={2.4} sx={{padding:'0 0 1rem 1rem'}}>
                                    <Card key={index} sx={{ 
                                        // minWidth: 250, 
                                        // width: 265, 
                                        // maxWidth: 300, 
                                        ...
                                        <Typography sx={{
                                            ...
                                            {
                                                dataPassion.find(passion => passion.id === elt.passion).passionName
                                            }
                                        </Typography>
                                        <CardContent >
