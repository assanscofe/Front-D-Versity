...
const Passions = () => {
  ...
  const renderMenu = (passionId, index, passion) => (
    <Menu
      ...
      sx={{ mt: 2 }}
    >
      <MenuItem onClick={() => handleEdit(passion)} sx={{ fontWeight: 600, my: 1, mx: 2 }}>Modifier</MenuItem>
      <MenuItem onClick={() => handleDelete(passionId)} sx={{ fontWeight: 600, my: 1, mx: 2 }}>Supprimer</MenuItem>
            ...
            >
              ...
              >
                ...
                <IconButton
                  aria-label="more"
                  id="long-button"
                  style={{ width: 15, height: 15, fill: '#444', marginLeft: 'auto' }}
                  aria-haspopup="true"
